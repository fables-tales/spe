...
public class DrawingImpl implements Drawing {
    ...
    function drawEdge(left1,top1, left2,top2,cWidth,cHeight)
    {
        ...
        drawPolygon(pvertices,2,canvas.width,canvas.height);
    }
    ...
    function drawVertex(left,top,width,cWidth,cHeight)
    {
        ...
        drawPolygon(pvertices,6,canvas.width,canvas.height);
    }
    
    function drawPolygon(pixelVertices,colorNum,cWidth,cHeight)
    {
        ...
        pyramidVertexPositionBuffer.numItems = vl / 3.0;
        ...
        pyramidVertexColorBuffer.numItems = vl / 3.0;
