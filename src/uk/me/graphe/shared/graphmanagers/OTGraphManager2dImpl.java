            ...
            if (eo.createsEdge(eo.getEdge())) {
                ...
                if (this.getUnderlyingGraph().getEdges().size() > 0) {
                    System.err.println(this.getUnderlyingGraph().getEdges()
                            .get(0));
                    Edge e2 = this.getUnderlyingGraph().getEdges()
                    .get(0);
                    System.err.println(e2.equals(eo.getEdge()));
                    System.err.println(e2.getFromVertex() + " " + eo.getEdge().getFromVertex());
                    System.err.println(e2.getToVertex() + " " + eo.getEdge().getToVertex());
                    System.err.println(e2.getDirection() + " " + eo.getEdge().getDirection());
                }
                Edge e = eo.getEdge();
                this.removeEdge(e);
            }
